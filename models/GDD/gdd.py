...
# guided deep decoder
class gdd(nn.Module):
    def __init__(self, num_input_channels=8, num_output_channels=8, 
        ...
        self.guide_enc = nn.Sequential(
                    conv(8, num_channels_down, filter_size_down, bias=need_bias, pad=pad),
    ...
    def forward(self, guide, noise):
        #guide.shape:  torch.Size([1, 8, 512, 512])
